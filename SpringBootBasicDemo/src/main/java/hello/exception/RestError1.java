...
public class RestError1 {
    ...
    public RestError1(String status, int code, String message, String developerMessage, String moreInfoUrl, Throwable throwable) {
        if (status == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof RestError1) {
            RestError1 re = (RestError1) o;
    ...
    public static class Builder {
        ...
        public RestError1 build() {
            if (this.status == null) {
                this.status = "Internal Server Error";
            }
            return new RestError1(this.status, this.code, this.message, this.developerMessage, this.moreInfoUrl, this.throwable);
        }
    }
}